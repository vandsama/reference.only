...
public class Lecture {
    ...
    */
    ...
    block in order to return it? There are a couple of different ways of doing this,
    ...
    */
    ...
    /*
    7. What will the variable result be at the end of the method? Change the number
        in the logic expression so that it returns true.
    */
