...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		String fullName = "samantha vanderburgh";
		...
		*/
		...
		final int hoursInYear = 2080;
		final double rateFactor = 1.07;
		final double hourlyPay = 15.0;
		final int PAY_PERIODS = 26;
		double r = hoursInYear * hourlyPay * rateFactor / PAY_PERIODS;
